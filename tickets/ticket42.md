...
- ## Запрет копирования и перемещения полиморфных объектов: синтаксиc
  ...
  Создаем базовый класс noncopyable. И наследуемся от него приватно. Теперь класс некопируемый.
  Приватное наследование, если не нужна совместимость по ссылкам/указателям.
