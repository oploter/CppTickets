...
- Universal character names -- коды символов (``\12, \x12, \u1234, \U12345678``)
  ...
  **Unicode** - концепт, который каждой букве сопоставляет code points (U+12DA - hex code point). Но не оговорено, как их хранить и представлять.
  ...
  ---
  Каждый code point хранить как 2 байта. <span style="background-color: #FFFF00">Пример:</span> U+120F -> 12 0F
  <span style="background-color: #FF0000">Проблема:</span> Есть системы big/small - endian. Тогда в small-endian: U+120F -> 0F 12
