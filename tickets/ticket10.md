...
**!Важно** Существует много разных стандартов кодирования, поэтому всегда нужно знать в какой кодировке закодирована строка.
...
**Типы строковых литералов**
  - Префикс определяет кодирование (u8 - UTF-8, 16 - UTF-16, U - UTF-32, L - 2 bytes)
...
```c++
    ...
    "AB"s + "CD" // string literals можно складывать
```
