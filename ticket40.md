...
Зачем наследование, если в derived можно хранить объект типа base --> Обращение по указателям/ссылкам
...
### Права доступа
Права доступа распространяется на класс, а не на class instance. Поэтому распространяется и на static члены.
